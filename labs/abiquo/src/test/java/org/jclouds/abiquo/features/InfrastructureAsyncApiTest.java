...
public class InfrastructureAsyncApiTest extends BaseAbiquoAsyncApiTest<InfrastructureAsyncApi> {
   ...
   public void testListNetworkServiceTypes() throws SecurityException, NoSuchMethodException, IOException {
      Method method = InfrastructureAsyncApi.class.getMethod("listNetworkServiceTypes", DatacenterDto.class);
      GeneratedHttpRequest request = processor.createRequest(method, InfrastructureResources.datacenterPut());

      assertRequestLineEquals(request, "GET http://localhost/api/admin/datacenters/1/networkservicetypes HTTP/1.1");
   ...
   public void testCreateNetworkServiceType() throws SecurityException, NoSuchMethodException, IOException {
      Method method = InfrastructureAsyncApi.class.getMethod("createNetworkServiceType", DatacenterDto.class,
            NetworkServiceTypeDto.class);
      GeneratedHttpRequest request = processor.createRequest(method, InfrastructureResources.datacenterPut(),
            InfrastructureResources.networkServiceTypePost());

      assertRequestLineEquals(request, "POST http://localhost/api/admin/datacenters/1/networkservicetypes HTTP/1.1");
      assertNonPayloadHeadersEqual(request, "Accept: " + NetworkServiceTypeDto.BASE_MEDIA_TYPE + "\n");
      assertPayloadEquals(request, withHeader(InfrastructureResources.networkServiceTypePostPayload()),
   ...
   public void testDeleteNetworkServiceType() throws SecurityException, NoSuchMethodException {
      Method method = InfrastructureAsyncApi.class.getMethod("deleteNetworkServiceType", NetworkServiceTypeDto.class);
      GeneratedHttpRequest request = processor.createRequest(method, InfrastructureResources.networkServiceTypePut());

      assertRequestLineEquals(request, "DELETE http://localhost/api/admin/datacenters/1/networkservicetypes/1 HTTP/1.1");
      assertNonPayloadHeadersEqual(request, "");
      assertPayloadEquals(request, null, null, false);
   ...
   public void testGetNetworkServiceType() throws SecurityException, NoSuchMethodException, IOException {
      Method method = InfrastructureAsyncApi.class.getMethod("getNetworkServiceType", DatacenterDto.class,
            Integer.class);
      GeneratedHttpRequest request = processor.createRequest(method, InfrastructureResources.datacenterPut(), 1);

      assertRequestLineEquals(request, "GET http://localhost/api/admin/datacenters/1/networkservicetypes/1 HTTP/1.1");
      assertNonPayloadHeadersEqual(request, "Accept: " + NetworkServiceTypeDto.BASE_MEDIA_TYPE + "\n");
      assertPayloadEquals(request, null, null, false);
   ...
   public void testUpdateNetworkServiceType() throws SecurityException, NoSuchMethodException, IOException {
      Method method = InfrastructureAsyncApi.class.getMethod("updateNetworkServiceType", NetworkServiceTypeDto.class);
      GeneratedHttpRequest request = processor.createRequest(method, InfrastructureResources.networkServiceTypePut());

      assertRequestLineEquals(request, "PUT http://localhost/api/admin/datacenters/1/networkservicetypes/1 HTTP/1.1");
      assertNonPayloadHeadersEqual(request, "Accept: " + NetworkServiceTypeDto.BASE_MEDIA_TYPE + "\n");
      assertPayloadEquals(request, withHeader(InfrastructureResources.networkServiceTypePutPayload()),
            NetworkServiceTypeDto.class, NetworkServiceTypeDto.BASE_MEDIA_TYPE, false);
