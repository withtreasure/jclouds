 ...
 */
// Since these tests block the thread, mark them as failed after the given
// timeout
...
public class BaseMonitoringServiceTest extends BaseInjectionTest {
   ...
   public void testMonitorMultipleTasksReachesTimeout() {
      ...
      service.monitor(TEST_MONITOR_POLLING + 10L, TimeUnit.MILLISECONDS, new MockInfiniteMonitor(), monitoredObject1,
            monitoredObject2);
      handler.lock();
   ...
   private static class MockMonitor implements Function<Object, MonitorStatus> {
      ...
      public MockMonitor() {
         this.finishAfterCount = 1; // Simulate task completion after one
                                    // refresh
      }
